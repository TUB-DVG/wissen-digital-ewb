...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        dataTranslated = translator.processTranslation(header, data, appDataImportObj.MAPPING_EXCEL_DB_EN)
        translator._writeToExcel(writeToFile, header, dataTranslated, appDataImportObj.MAPPING_EXCEL_DB_EN)
