...
class Weatherdata(models.Model):
    data_service = models.CharField(
        max_length=150, help_text="Name der Anwendung", blank=True
    )
    ...
    provider = models.CharField(
        max_length=150, help_text="Provider des DatenService", blank=True
    )
    further_information = models.CharField(
        max_length=500,
    ...
    last_update = models.CharField(
        max_length=100, help_text="letztes Update des DatenServices", blank=True
    )
    license = models.CharField(
        max_length=200, help_text="Lizenz des DatenServices", blank=True
    )
