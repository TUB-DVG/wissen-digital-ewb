...
for k in range(0, station_data.shape[0]):
    ...
    if station_data["value"][LaufV_Stunden] <= -15:
        ...
        station_data["value"][LaufV_Stunden] <= -10
        and station_data["value"][LaufV_Stunden] > -15
    ):
        Zeile = 1
    elif (
        station_data["value"][LaufV_Stunden] <= -5
        and station_data["value"][LaufV_Stunden] > -10
    ):
        Zeile = 2
    elif (
        station_data["value"][LaufV_Stunden] <= 0
        and station_data["value"][LaufV_Stunden] > -5
    ):
        Zeile = 3
    elif (
        station_data["value"][LaufV_Stunden] <= 5
        and station_data["value"][LaufV_Stunden] > 0
    ):
        Zeile = 4
    elif (
        station_data["value"][LaufV_Stunden] <= 10
        ...
        station_data["value"][LaufV_Stunden] <= 15
        and station_data["value"][LaufV_Stunden] > 10
    ):
        Zeile = 6
    elif (
        station_data["value"][LaufV_Stunden] <= 20
        and station_data["value"][LaufV_Stunden] > 15
    ):
        Zeile = 7
        # Here is a difference
    elif (
        station_data["value"][LaufV_Stunden] <= 25
        and station_data["value"][LaufV_Stunden] > 20
    ):
        Zeile = 8
    else:
        Zeile = 9
    ...
    try:
        ...
        Q.append(
            ...
            * (Q_average / h_average)
            * F
            * W_Tag[station_data["date"][LaufV_Stunden].weekday()]
        )
