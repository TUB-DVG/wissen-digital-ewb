...
class TestDataImport(TestCase):
    ...
    def testDataImportCommand(self):
        ...
        for protocol in allProtocols:
            ...
            self.assertNotEqual(protocol.license.all()[0].openSourceStatus_en, None)
            self.assertNotEqual(protocol.license.all()[0].licensingFeeRequirement_en, None)
    ...
    def testIfLicenseObjectsAreInstanciated(self):
        ...
        testStringForLicenseClass = [
            (None, "Open Source", "Fee Required", "Open Source", "Fee Required"),
            ("MIT", "Open Source", "No Fee Required", "Open Source", "Fee Required"),
        ...
        for index, testTuple in enumerate(testStringForLicenseClass):
            ...
            self.assertEqual(testTuple[2], returnedListOfLicenseObjs[index].licensingFeeRequirement)
            self.assertEqual(testTuple[3], returnedListOfLicenseObjs[index].openSourceStatus_en)
            self.assertEqual(testTuple[4], returnedListOfLicenseObjs[index].licensingFeeRequirement_en)
