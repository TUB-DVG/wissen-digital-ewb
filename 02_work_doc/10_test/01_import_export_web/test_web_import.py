...
for fkz in fkz_test:
   ...
   WHERE fkz = '%s'
    ...
    db_fkz_plz_zwe = df_db[df_db['fkz'] == fkz]['thema']
    print(db_fkz_plz_zwe)

    xlsx_fkz_plz_zwe= df_xlsx[df_xlsx['fkz']==str(fkz)]['PLZ_ZWE']
    print(xlsx_fkz_plz_zwe)
