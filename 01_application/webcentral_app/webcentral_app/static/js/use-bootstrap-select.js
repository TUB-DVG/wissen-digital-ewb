...
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
  ...
  var _tmpl$ = /* @__PURE__ */ template(`<div>`), _tmpl$2 = /* @__PURE__ */ template(`<div class="d-flex align-items-center gap-1 flex-wrap flex-grow-1 w-100 overflow-hidden">`), _tmpl$3 = /* @__PURE__ */ template(`<div class=input-wrapper><span></span><input type=text>`), _tmpl$4 = /* @__PURE__ */ template(`<span role=button class="ms-auto link-secondary d-inline-flex flex-shrink-0">`), _tmpl$5 = /* @__PURE__ */ template(`<div class="dropdown-item active">`), _tmpl$6 = /* @__PURE__ */ template(`<div class="dropdown-item pe-none">`), _tmpl$7 = /* @__PURE__ */ template(`<div data-bs-popper class="dropdown-menu w-100">`), _tmpl$8 = /* @__PURE__ */ template(`<h6 class=dropdown-header>`), _tmpl$9 = /* @__PURE__ */ template(`<span>`), _tmpl$10 = /* @__PURE__ */ template(`<svg class=pe-none xmlns=http://www.w3.org/2000/svg width=1em height=1em viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><line x1=18 y1=6 x2=6 y2=18></line><line x1=6 y1=6 x2=18 y2=18>`);
  ...
  const _UseBootstrapSelect = class _UseBootstrapSelect {
    ...
    update() {
      this.selectElement.setAttribute("count", this.getSelected().length.toString());
      const spanDomElement = document.getElementById(`span-${this.selectElement.id}`);
      if (spanDomElement != null) {
        spanDomElement.textContent = `${this.selectElement.getAttribute("count")} selected`;
      }
      if (spanDomElement != null && this.selectElement.getAttribute("count") === "0") {
        spanDomElement.textContent = "";
      }
      ...
      const Component = () => {
        ...
        const InputWrapper = () => {
          ...
          return (() => {
                  ...
                  if (config().searchable && text() === "") {
                    if (isMultiple()) {
                      ...
                      if (selectedOption.length > 0) {
                        _self$.removeValue(selectedOption[selectedOption.length - 1].value);
                      }
                    } else {
                      _self$.clearValue();
                    }
            ...
            typeof _ref$ === "function" ? use(_ref$, _el$6) : inputElement = _el$6;
            createRenderEffect((_p$) => {
              var _v$4 = !!(config().searchable && focus() || filter(selected()).length < 1), _v$5 = placeholder(), _v$6 = !config().searchable && !isDisabled(), _v$7 = isDisabled();
              _v$4 !== _p$.e && _el$4.classList.toggle("position-relative", _p$.e = _v$4);
              _v$5 !== _p$.t && setAttribute(_el$6, "placeholder", _p$.t = _v$5);
              _v$6 !== _p$.a && (_el$6.readOnly = _p$.a = _v$6);
              _v$7 !== _p$.o && (_el$6.disabled = _p$.o = _v$7);
              return _p$;
            }, {
              e: void 0,
              t: void 0,
            ...
            createRenderEffect(() => _el$6.value = text());
            return _el$4;
          })();
        };
        const ClearButton = () => {
          ...
          return createComponent(Show, {
            ...
            get children() {
              ...
              insert(_el$7, createComponent(XIcon, {}));
              createRenderEffect(() => _el$7.classList.toggle("d-none", !!(filter(selected()).length < 1)));
              return _el$7;
            }
          });
        };
        const DropdownItemsWrapper = ({
          ...
          return (() => {
            ...
            typeof _ref$2 === "function" ? use(_ref$2, _el$8) : dropdownItemsWrapper = _el$8;
            insert(_el$8, children);
            return _el$8;
          })();
        };
        const DropdownItem = ({
          ...
          return (() => {
            ...
            _el$9.$$click = () => {
              if (isMultiple()) {
                const element = document.querySelector(".align-items-center.gap-1.d-inline-flex.py-0.border-0.btn.text-bg-secondary");
                if (!item.selected) {
                  _self$3.addValue(item.value);
                } else {
                  _self$3.removeValue(item.value);
                }
                if (element) {
                  console.log(_self$3);
                  element.textContent = `${_self$3.selectElement.selectedOptions.length} ausgewählt`;
                }
              } else {
                _self$3.setValue(item.value);
                hide();
              }
            };
            _el$9.$$mouseover = (e) => {
            ...
            createRenderEffect((_p$) => {
              var _v$8 = `dropdown-item ${item.selected ? "green-tick" : ""}`, _v$9 = item.value, _v$10 = !!(item.label !== void 0), _v$11 = !!item.disabled, _v$12 = !!item.selected, _v$13 = !!item.selected, _v$14 = item.text;
              _v$8 !== _p$.e && className(_el$9, _p$.e = _v$8);
              _v$9 !== _p$.t && setAttribute(_el$9, "data-value", _p$.t = _v$9);
              _v$10 !== _p$.a && _el$9.classList.toggle("optgroup-item", _p$.a = _v$10);
              _v$11 !== _p$.o && _el$9.classList.toggle("disabled", _p$.o = _v$11);
              _v$12 !== _p$.i && _el$9.classList.toggle("active", _p$.i = _v$12);
              _v$13 !== _p$.n && _el$9.classList.toggle("selected", _p$.n = _v$13);
              _v$14 !== _p$.s && (_el$9.innerHTML = _p$.s = _v$14);
              return _p$;
            }, {
              e: void 0,
              t: void 0,
        ...
        const DropdownMenu = () => {
          return (() => {
            ...
            typeof _ref$3 === "function" ? use(_ref$3, _el$10) : dropdownMenu = _el$10;
            insert(_el$10, createComponent(DropdownItemsWrapper, {
              get children() {
            ...
            insert(_el$10, createComponent(Show, {
              ...
              get children() {
                var _el$11 = _tmpl$5();
                _el$11.$$click = create;
                createRenderEffect(() => _el$11.innerHTML = config().creatableText.replace("{value}", text()));
                return _el$11;
              }
            }), null);
            insert(_el$10, createComponent(Show, {
              ...
              get children() {
                var _el$12 = _tmpl$6();
                insert(_el$12, () => config().noResultsText);
                return _el$12;
              }
            }), null);
            createRenderEffect((_p$) => {
              var _v$15 = !!shown(), _v$16 = config().maxHeight;
              _v$15 !== _p$.e && _el$10.classList.toggle("show", _p$.e = _v$15);
              _v$16 !== _p$.t && ((_p$.t = _v$16) != null ? _el$10.style.setProperty("max-height", _v$16) : _el$10.style.removeProperty("max-height"));
              return _p$;
            }, {
              e: void 0,
              t: void 0
                ...
                return [createComponent(DropdownToggleContentWrapper, {
                  get children() {
                    return [createComponent(Show, {
                      ...
                      get children() {
                        var _el$14 = _tmpl$9();
                        createRenderEffect(() => setAttribute(_el$14, "id", `span-${_self$4.selectElement.id}`));
                        return _el$14;
                      }
  ...
  delegateEvents(["mousedown", "keydown", "input", "click", "mouseover"]);
