# Generated by Django 4.2.1 on 2024-04-24 05:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bibtex_types_de', models.CharField(default='article', help_text='Possible BibTex types, separated by comma.', max_length=256, null=True, verbose_name='BibTex types')),
                ('bibtex_types_en', models.CharField(default='article', help_text='Possible BibTex types, separated by comma.', max_length=256, null=True, verbose_name='BibTex types')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journal_de', models.CharField(blank=True, max_length=256, null=True)),
                ('journal_en', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('institution_de', models.CharField(blank=True, max_length=256, null=True)),
                ('institution_en', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('keywords', models.CharField(blank=True, help_text='List of keywords separated by commas.', max_length=512)),
                ('keywords_de', models.CharField(blank=True, help_text='List of keywords separated by commas.', max_length=512, null=True)),
                ('keywords_en', models.CharField(blank=True, help_text='List of keywords separated by commas.', max_length=512, null=True)),
                ...
                ('copyright_de', models.CharField(blank=True, max_length=256, null=True)),
                ('copyright_en', models.CharField(blank=True, max_length=256, null=True)),
